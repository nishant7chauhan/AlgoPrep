...
/**
 * prefix based search, string search
 * 
 * @author nishant.chauhan
 *
 *O(l) length of string
 */


public class Trie {

	class TrieNode {   //note not defined public to use in other class
	...
	public static void main(String[] args) {
		...
		System.out.println("abc: "+obj.search("abc"));
		System.out.println("abd: "+obj.search("abd"));
		System.out.println("abcd: "+obj.search("abcd"));
