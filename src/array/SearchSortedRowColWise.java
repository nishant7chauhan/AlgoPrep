 ...
 * O(n) as row wise and col wise sorted , O(logn) if matrix strictly sorted i.e first element of row is greater than last element of perv row.
 */



public class SearchSortedRowColWise {
